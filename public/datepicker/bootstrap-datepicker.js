...
!function( $ ) {
	...
	var Datepicker = function(element, options) {
		...
		if (this.isRTL){
			...
			this.picker.find('.prev i, .next i')
						.toggleClass('bi bi-chevron-double-left bi bi-chevron-double-right');
		}
				...
				switch(target[0].nodeName.toLowerCase()) {
					...
					case 'td':
						if (target.is('.day') && !target.is('.disabled')){
							...
							this._setDate(UTCDate(year, month, day,0,0,0,0));
							this.hide(); //ไว้สำหรับเลือกวันแล้วจะปิดเอง
						}
						break;
				}
			}
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="bi bi-chevron-double-left"/></th>'+
								'<th colspan="5" class="datepicker-switch"></th>'+
								'<th class="next"><i class="bi bi-chevron-double-right"/></th>'+
							'</tr>'+
						'</thead>',
